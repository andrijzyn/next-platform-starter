...
- [ ] Виправити адаптацію дизайну під моб. девайси
- [ ] Обмежити можливість аутентифікації до акаунту більше ніж одному користувачу
- [ ] Реалізувати логування дій користувачів
- [ ] Реалізувати фільтрування SKU по рівню доступу користувача
- [ ] Створити інструмент перегляду інформації про товар по айді/локації
- [ ] Створити інструмент-форму для системного завантаження локацій
- [ ] Додати додаткові фільтри та класи до предметів (тип об'єкта, рівень секретності, тип зберігання)
- [ ] Реалізувати інструмент налаштування 3D матриці склаських полиць
   - [ ] Додати можливість позначати тип складу по товару
   - [ ] Додати можливість позначати тип складу по поверхам баферної зони
   - [ ] Врахування ваги та можливих габаритів товару
   - [ ] Створити інформаційну панель з позначенням завантаження локацій та швидким доступом до списку товару по локації

- [ ] - [ ] Провести стресс тест БД та хосту
